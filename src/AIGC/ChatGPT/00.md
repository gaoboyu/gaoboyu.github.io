...
Quality
--quality <.25, .5, 1>, or --q <.25, .5, 1> How much rendering quality time you want to spend. The default value is 1. Higher values cost more and lower values cost less.
...
Stop
--stop <integer between 10–100> Use the --stop parameter to finish a Job part way through the process. Stopping a Job at an earlier percentage can create blurrier, less detailed results.
...
|  |  |  |  |  |
| ------- | --------- | -------- | ------------- | ---------- |
| (style) | (artists) | (Medium) | (Environment) | (Lighting) |
